function [w_t,dnb_t,l0_t,theta_0t,Ia,Ib]=tenseg_load_prestress_ori(substep,ind_w,w0,ind_dn,dn0,ind_l0,dl0,ind_theta_0,dtheta_0,theta_0,l0,b,gravity,acc,C,mass)
...
%   ind_theta_0: index of the hinge with changing angle(a vector);
%   dtheta_0: difference of the initial angle
...
%   theta_0t: time history of hinge angle
