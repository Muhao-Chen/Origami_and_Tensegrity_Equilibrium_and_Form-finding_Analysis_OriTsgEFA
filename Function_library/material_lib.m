...
% https://github.com/Muhao-Chen/Tensegrity_Finite_Element_Method_TsgFEM/tree/main/Function_library/material_lib.m
%
...
%         rho_b = 7870;
        ...
        strain_b1=[1456e-6,23301e-6,10];  % strain of bar Q345
...
switch string_material
    case 'Steel_string'
        rho_s = 7870;
        strain_s1=[0.016099,0.1,10];  % strain of string
        stress_s1=1e6*[1223.5,1600,1600];              % stress of string
