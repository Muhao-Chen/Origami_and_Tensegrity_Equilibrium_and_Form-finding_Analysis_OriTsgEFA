function [fig_out] = tenseg_plot_ori( N,C_b,C_s,C_h,C_rh,fig_handle,highlight_nodes,view_vec, PlotTitle, R3Ddata,Ca)
% /* This Source Code Form is subject to the terms of the Mozilla Public
% * License, v. 2.0. If a copy of the MPL was not distributed with this
% * file, You can obtain one at http://mozilla.org/MPL/2.0/.
%
% [fig_out] = TENSEG_PLOT_ORI( N,C_b,C_s,C_h,C_rh,fig_handle,highlight_nodes,view_vec,PlotTitle,R3Ddata,Ca)
...
for i=1:num_rbd
   ...
   patch(X',Y',Z','b','FaceAlpha',0.6,'EdgeColor','none');    
